  ...
  return (
    <div className={isMonochrome ? "theme-monochrome" : "theme-colorful"}>
      ...
      >
        ...
        />
        <section className="relative text-center w-screen h-auto">
          <div
            className={`mx-auto relative top-28 left-1/2 transform -translate-x-1/2 ${
              isBannerHidden ? "unstyle-banner" : "banner"
            }`}
          >
            <h1 className={`text-8xl text-center text-white relative`}>
              <span className="block transform skew-y-3 bg-blue-200 bg-opacity-40 px-4 py-2 border-t-4 border-b-4 border-white-200">
                TINY LOTTO!
              </span>
            </h1>

            <p className="text-lg mt-8 max-w-2xl mx-auto font-pusab">
        ...
        <div
          className={`hiddenIntro mx-auto py-auto flex justify-center ${
            hiddenIntro ? "show" : ""
          }`}
        >
          <h2 className="text-8xl">Sign-up coming soon!</h2>
        </div>
      </main>
