...
function HowItWorks() {
  ...
  return (
    <div className="theme-monochrome">
      ...
      >
        ...
        <section className="relative text-center py-20 px-4 md:py-32">
          <h1 className="text-5xl md:text-7xl lg:text-8xl text-white font-bold">
            <span className="block bg-blue-200 bg-opacity-40 px-4 py-2 border-t-4 border-b-4 border-white">
              How It Works
            </span>
          </h1>
        ...
        <section className="relative py-20 px-6 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              {/* Step 3 */}
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full bg-muted-teal text-charcoal text-2xl font-bold">
                  3
                </div>
                <h3 className="text-2xl font-bold mb-4">Win Big!</h3>
                <p className="text-md text-gray-300">
        ...
        <section className="relative py-20 px-6 bg-gray-900 text-white">
          <div className="container mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-4">Exciting Prizes</h3>
                <p className="text-md text-gray-300">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold mb-4">Tradeable Assets</h3>
                <p className="text-md text-gray-300">
      ...
      {/* Footer */}
      <footer className="bg-gray-800 text-soft-white py-8">
        <div className="container mx-auto px-6 text-center">
          <p className="text-muted-teal mb-4">
            Ready to start your TinyLotto journey?
          </p>
          <button
